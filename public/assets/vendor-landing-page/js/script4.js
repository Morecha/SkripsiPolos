...
$('#js-grid-mosaic').cubeportfolio({
    ...
    $('.portofolio-img-gallery').owlCarousel({
    ...
    $('#lightbox-portofolio-img').cubeportfolio({
        lightboxDelegate: '.cbp-lightbox',
        lightboxGallery: true,
        lightboxTitleSrc: 'data-title',
        lightboxCounter: '<div class="cbp-popup-lightbox-counter">{{current}} of {{total}}</div>',
    ...
    $('#lightbox-portofolio').cubeportfolio({
        layoutMode: 'slider',
        auto: false,
        showPagination: true,
    ...
    $('#lightbox-spesifikasi-img').cubeportfolio({
        layoutMode: 'slider',
        auto: false,
        showPagination: true,
        showNavigation: false,
    ...
    $('#spesifikasi-produk-carousal').owlCarousel({
        items:2,
        loop:false,
        autoplay:false,
        center:true,
