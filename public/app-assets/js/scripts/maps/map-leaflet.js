...
$(function () {
  ...
  // --------------------------------------------------------------------
  if ($('#basic-map').length) {
    var basicMap = L.map('basic-map').setView([-7.94, 112.63], 13);
    L.tileLayer('https://{s}.tile.osm.org/{z}/{x}/{y}.png', {
      attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
      maxZoom: 18
    }).addTo(basicMap);
    L.marker([-7.94, 112.63]).addTo(basicMap).bindPopup('Nakula Sadewa <br> tempatku magang');
    L.marker([-7.95, 112.61]).addTo(basicMap).bindPopup('FILKOM UB <br> tempatku kuliah');
  }
