                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{route('users.store')}}" method="POST" class="mt-2" enctype="multipart/form-data">
                                        @csrf
                                        {{-- first line --}}
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="mb-2">
                                                    ...
                                                    <select name="role" id="role" class="form-select">
                                                        <option value="Admin">Petugas Perpustakaan</option>
                                                        <option value="PenanggungJawab">Penanggung Jawab Perpustakaan</option>
