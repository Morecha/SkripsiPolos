                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{route('user.update', $user->id)}}" method="POST" class="mt-2" enctype="multipart/form-data">
                                        @csrf
                                        {{-- first line --}}
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" id="name" class="form-control" name="name" autocomplete="false" value="{{$user->name}}"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    <label class="form-label" for="emaila">Email</label>
                                                    <input type="email" id="email" class="form-control" name="email" autocomplete="false" value="{{$user->email}}"/>
                                                </div>
                                            </div>
                                        </div>
                                        {{-- second line --}}
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <div class="input-group form-password-toggle input-group-merge">
                                                        <input type="text" class="form-control" id="NIP" name="NIP" placeholder="NIP" autocomplete="false" value="{{$user->NIP}}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <div class="input-group form-password-toggle input-group-merge">
                                                        <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" placeholder="tanggal_lahir" autocomplete="false" value="{{substr($user->tanggal_lahir, 0, 10)}}"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <div class="input-group form-password-toggle input-group-merge">
                                                        <input type="text" class="form-control" id="alamat" name="alamat" placeholder="alamat" autocomplete="false" value="{{$user->alamat}}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <div class="input-group form-password-toggle input-group-merge">
                                                        <input type="text" class="form-control" id="jabatan" name="jabatan" placeholder="jabatan" autocomplete="false" value="{{$user->jabatan}}"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
