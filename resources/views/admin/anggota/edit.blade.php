                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{route('anggota.update', $anggota->id)}}" method="POST" class="mt-2" enctype="multipart/form-data">
                                        @csrf
                                        {{-- first line --}}
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="number" id="angkatan" class="form-control" name="angkatan" autocomplete="false" value="{{$anggota->angkatan}}"/>
                                                </div>
                                            </div>
                                        </div>
                                        {{-- second line --}}
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <div class="input-group form-password-toggle input-group-merge">
                                                        <input type="number" class="form-control" id="NIS" name="NIS" placeholder="NIS" autocomplete="false" value="{{$anggota->NIS}}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <div class="input-group form-password-toggle input-group-merge">
                                                        <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" placeholder="tanggal_lahir" autocomplete="false" value="{{substr($anggota->tanggal_lahir,0,10)}}"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <div class="input-group form-password-toggle input-group-merge">
                                                        <input type="text" class="form-control" id="alamat" name="alamat" placeholder="alamat" autocomplete="false" value="{{$anggota->alamat}}"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="mb-2">
                                                    ...
                                                    <select name="status" id="status" class="form-select">
                                                        ...
                                                        <option value="non-aktif" @if($anggota->status == 'non-aktif') selected @endif>Non-Aktif</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
