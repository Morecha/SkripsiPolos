            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Anggota Create</h2>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{route('anggota.store')}}" method="POST" class="mt-2" enctype="multipart/form-data">
                                        @csrf
                                        {{-- first line --}}
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="number" id="angkatan" class="form-control" name="angkatan" autocomplete="false"/>
                                                </div>
                                            </div>
                                        </div>
                                        {{-- second line --}}
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <div class="input-group form-password-toggle input-group-merge">
                                                        <input type="number" class="form-control" id="NIS" name="NIS" placeholder="NIS" autocomplete="false"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
