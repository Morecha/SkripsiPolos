            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Create Presensi Kelompok</h2>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{route('presensi.kelompok.store')}}" method="POST" class="mt-2" enctype="multipart/form-data">
                                        @csrf
                                        {{-- first line --}}
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="number" id="jumlah" class="form-control" name="jumlah" autocomplete="false"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <textarea name="keterangan" id="textarea" cols="30" rows="5"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        {{-- button --}}
