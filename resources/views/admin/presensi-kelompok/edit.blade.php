                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    @if ($data->status_presensi == 'individu')
                                                        <input type="number" id="jumlah" class="form-control" name="jumlah" autocomplete="false" disabled/>
                                                    @endif
                                                        <input type="number" id="jumlah" class="form-control" name="jumlah" autocomplete="false" value="{{$data->jumlah}}"/>
                                                </div>
                                            </div>
                                        </div>
