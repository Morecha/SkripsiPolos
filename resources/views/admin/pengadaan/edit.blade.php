                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{route('pengadaan.update', $data->id)}}" method="POST" class="mt-2" enctype="multipart/form-data">
                                        @csrf
                                        {{-- first line --}}
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="number" class="form-control" id="eksemplar" name="eksemplar" placeholder="eksemplar" autocomplete="false" value="{{ $data->eksemplar }}" min="{{$data->diterima}}"/>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-6">
                                                <div class="mb-2">
                                                    <label class="form-label" for="diterima">diterima</label>
                                                    <input type="number" class="form-control" id="diterima" name="diterima" placeholder="diterima" autocomplete="false" value="{{ $data->diterima }}" disabled/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
