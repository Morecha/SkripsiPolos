                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="number" class="form-control" id="lama_peminjaman" name="lama_peminjaman" placeholder="lama peminjaman" autocomplete="lama_peminjaman" value="{{ $dipinjam->lama_peminjaman }}" min="1"/>
                                                </div>
                                            </div>
                                        </div>
