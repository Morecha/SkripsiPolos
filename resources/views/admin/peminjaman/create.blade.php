                                ...
                                <div class="card-body">
                                    ...
                                    {{-- <form action="" method="POST" class="mt-2" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    <label class="form-label" for="judul">Anggota</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-1">
                                                ...
                                                <div id="kodeBukuContainer" class="kode-buku-group">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="mb-2">
                                                    <label class="form-label" for="penerbit">Lama Peminjaman</label>
                                    ...
                                    <form action="{{route('peminjaman.store')}}" method="POST" class="mt-2" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    <label class="form-label" for="lama_peminjaman">Lama Peminjaman</label>
                                                    <input type="number" class="form-control" id="lama_peminjaman" name="lama_peminjaman" placeholder="lama peminjaman" autocomplete="lama_peminjaman"/>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    document.getElementById('addKodeBuku').addEventListener('click', function() {
        ...
        newKodeBukuGroup.querySelector('select').selectedIndex = 0;
